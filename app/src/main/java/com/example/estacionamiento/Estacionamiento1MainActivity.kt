...
//Clase Estacionamiento para almacenar y mostrar el nombre y el estado
data class Estacionamiento(val nombre: String, var estado: String){
    override fun toString(): String {
        return "$nombre - $estado"
    }
}

class Estacionamiento1MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_estacionamiento1_main)
